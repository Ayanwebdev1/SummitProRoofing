    ...
    return (
        <>
            <div>
                ...
                <p className='text-center text-[20px] mt-3 m-auto text-gray-500 w-[90vw] md:w-[50vw]'>We don't just fix roofs; we build peace of mind. Our certified team delivers superior results on every project.</p>
            </div>

            <div className='servicecards flex justify-center flex-col md:flex-row flex-wrap mt-5 gap-5'>
                <div className="card hover:shadow-2xl cursor-pointer transition duration-100 ease-in-out hover:border-t-orange-600 border border-gray-200 rounded-lg w-[90vw] md:w-[30vw] md:m-0 m-auto md:h-[20vw] shadow-lg">
