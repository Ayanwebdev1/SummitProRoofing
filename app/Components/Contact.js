...
const Contact = () => {
  return (
    ...
    <section>
        ...
        <p className='w-[90vw] md:w-[60vw] text-[20px] text-gray-500 m-auto text-center mt-2'>Tell us what you need and our team will reach out with pricing and next steps. This form is for roof repair, installation, inspection, or storm damage requests.</p>
